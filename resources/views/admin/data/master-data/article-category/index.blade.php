...
@section('container')
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                onclick="deleteDialog('{{ route('admin.data.master-data.article-category.destroy', $item->id) }}')">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content rounded shadow">
                ...
                <div class="modal-body">
                    <form class="form" id="form-modal" action="{{ route('admin.data.master-data.article-category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
    ...
    <script>
        function openFormDialog(target, type, id, name) {
            if (type === 'add') {
                $('#' + target + ' form').attr('action', '{{ route('admin.data.master-data.article-category.store') }}');
                $('#' + target + ' .form-control').val('');
                $('#' + target + ' input[name="name"]').attr('required', 'required');
            } else if (type === 'edit') {
                $('#' + target + ' .clear-after').val('');
                $('#' + target + ' form').attr('action', '{{ route('admin.data.master-data.article-category.update') }}');
