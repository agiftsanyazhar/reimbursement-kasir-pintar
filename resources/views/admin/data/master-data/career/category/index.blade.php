            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.data.master-data.career.index') }}">Karir</a></li>
                        <li class="breadcrumb-item">{{ $career->name }}</li>
                        <li class="breadcrumb-item">Kategori Karir</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <h5 class="card-title">
                    ...
                    <span>
                        <button type="button" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#modal-form"
                            onclick="openFormDialog('modal-form', 'add', '{{ $career->id }}')"><i class="bi bi-plus-lg"></i></button>
                    </span> 
                </h5>
            </div>
            <div class="card-body">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                onclick="deleteDialog('{{ route('admin.data.master-data.career-category.destroy', ['id' => $item->id, 'career_id' => $item->career_id]) }}')">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control clear-after" type="hidden" name="career_id">
    ...
    <script>
        function openFormDialog(target, type, id, name, career_id) {
            if (type === 'add') {
                ...
                $('#' + target + ' input[name="career_id"]').val(id);
            } else if (type === 'edit') {
