...
*/ (function () {
                        var u = (function () {
                            ...
                            function _(T, j) {
                                for (
                                    var S = j.split(A), L = S.length, W = 0;
                                    W < L;
                                    ++W
                                )
                                    T[S[W]] = !0;
                    ...
                    var w = {
                        ...
                        N = {
                            ...
                            setOptions: function (Y) {
                                var X =
                                    typeof Y == "function" ? Y(w.options) : Y;
                                R(),
                                ...
                                var Q = _s(
                                    bs([].concat(i, w.options.modifiers))
                                );
                                return (
                                    (w.orderedModifiers = Q.filter(function (
                                        V
                                    ) {
                                        return V.enabled;
                                    })),
